...
const UserSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'favoritesSeries': LinkSchema(
      id: 95899174949270703,
...
User _userDeserialize(
  ...
  final object = User(
    ...
    passwordHash: reader.readString(offsets[2]),
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> favoritesSeries(
      FilterQuery<SerieDetails> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'favoritesSeries');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> favoritesSeriesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'favoritesSeries', length, true, length, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> favoritesSeriesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'favoritesSeries', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> favoritesSeriesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'favoritesSeries', 0, false, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> favoritesSeriesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'favoritesSeries', 0, true, length, include);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition>
      favoritesSeriesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'favoritesSeries', length, include, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> favoritesSeriesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
