...
import 'package:seriesradar_app/features/serie/domain/datasources/season_datasources.dart';
import 'package:seriesradar_app/features/serie/domain/entities/season_details.dart';
import 'package:seriesradar_app/features/serie/infrastructure/mappers/season_details_mapper.dart';
...
class SeasonDatasourcesImpl extends SeasonDatasources {
  ...
  Future<SeasonDetails> getSeasonDetails(int serieId, int seasonNumber) async {
    ...
    final SeasonDetails season =
        SeasonDetailsMapper.serieDetailstoEntity(seasonDetails);
