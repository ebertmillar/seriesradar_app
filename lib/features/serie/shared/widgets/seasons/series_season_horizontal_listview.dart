        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: widget
                  .seasons.length, // Usamos la lista de temporadas directamente
              scrollDirection: Axis.horizontal,
              physics: const BouncingScrollPhysics(),
              itemBuilder: (context, index) {
                final season = widget.seasons[index];
                final serie =
                    widget.serie; // Obtener la temporada correspondiente
                return FadeInRight(
                  child: _Slide(
...
class _Slide extends StatelessWidget {
  ...
  const _Slide(
      {required this.serie,
      required this.season}); // Constructor ajustado para recibir Season
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () => context
                .push('/series/${serie.id}/season/${season.seasonNumber}'),
            child: Stack(
              children: [
                SizedBox(
                  width: 150,
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.network(
                      ...
                      season
                          .posterPath, // Asegúrate de tener el valor correcto para posterPath
                      fit: BoxFit.cover,
                      width: 150,
                      height: 225,
